...
--[[
  ...
  -- LC D1 white Set
  PrecacheItemByNameSync("item_lc_d1_white_boots_datadriven", context)
  PrecacheItemByNameSync("item_lc_d1_white_boots_active_datadriven", context)
  PrecacheItemByNameSync("item_lc_d1_white_weapon_datadriven", context)
  PrecacheItemByNameSync("item_lc_d1_white_chest_datadriven", context)
